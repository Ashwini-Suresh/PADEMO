...
public interface IPersonalAccount extends android.os.IInterface
{
  ...
  {
    @Override public java.util.List<com.example.settingsapplication.ProfileData> getAllProfile() throws android.os.RemoteException
    {
      return null;
    }
  ...
  public static abstract class Stub extends android.os.Binder implements common.IPersonalAccount
  {
    ...
    @Override public boolean onTransact(int code, android.os.Parcel data, android.os.Parcel reply, int flags) throws android.os.RemoteException
    {
      ...
      switch (code)
      {
        ...
        case TRANSACTION_getAllProfile:
        {
          ...
          java.util.List<com.example.settingsapplication.ProfileData> _result = this.getAllProfile();
    ...
    private static class Proxy implements common.IPersonalAccount
    {
      ...
      @Override public java.util.List<com.example.settingsapplication.ProfileData> getAllProfile() throws android.os.RemoteException
      {
        ...
        java.util.List<com.example.settingsapplication.ProfileData> _result;
        try {
          ...
          _result = _reply.createTypedArrayList(com.example.settingsapplication.ProfileData.CREATOR);
        }
        finally {
          _reply.recycle();
          _data.recycle();
  ...
  public java.util.List<com.example.settingsapplication.ProfileData> getAllProfile() throws android.os.RemoteException;
